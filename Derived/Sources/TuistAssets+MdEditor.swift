...
public enum Asset {
  ...
  public static let aboutApp = ImageAsset(name: "aboutApp")
  public static let file = ImageAsset(name: "file")
  public static let folder = ImageAsset(name: "folder")
  public static let newFile = ImageAsset(name: "newFile")
  public static let openFile = ImageAsset(name: "openFile")
